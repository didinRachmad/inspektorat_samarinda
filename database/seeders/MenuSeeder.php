...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $menus = [
            ...
            ['title' => 'Jenis Pengawasan', 'route' => 'jenis_pengawasan', 'icon' => null, 'order' => 6, 'parent_title' => 'Master'],
            ...
            ['title' => 'LHP', 'route' => 'lhp', 'icon' => null, 'order' => 1, 'parent_title' => 'Pelaksanaan'],
            ['title' => 'KKA', 'route' => 'kka', 'icon' => null, 'order' => 2, 'parent_title' => 'Pelaksanaan'],
            ['title' => 'Tindak Lanjut & Temuan', 'route' => 'tindak_lanjut_temuan', 'icon' => null, 'order' => 3, 'parent_title' => 'Pelaksanaan'],
