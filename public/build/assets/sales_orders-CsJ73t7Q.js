import{r as c}from"./routes-D3ctfpXk.js";import{A as r}from"./dashboard-CAmSZEv3.js";import{f as u}from"./format-B7a5NblC.js";import"./parse-B3pZ8sEA.js";import"./vendor-DcHDpzIg.js";const p={datatable:()=>c("transaksi_sales_orders.data"),getCustomers:()=>c("master_customers.getCustomers")};class b{constructor(){this.pageName="Sales Orders",this.datatableEl=$("#datatables"),this.customerSelectEl=$("#selectCustomer")}initIndex(){console.log(`Halaman ${this.pageName} Index berhasil dimuat!`),this.initDataTable()}initShow(){console.log(`Halaman ${this.pageName} Show berhasil dimuat!`)}initCreate(){console.log(`Halaman ${this.pageName} Create berhasil dimuat!`),this.initForm()}initEdit(){console.log(`Halaman ${this.pageName} Edit berhasil dimuat!`),this.initForm()}initDataTable(){this.datatableEl.DataTable({processing:!0,serverSide:!0,ajax:p.datatable(),columns:[{data:"DT_RowIndex",name:"DT_RowIndex",className:"text-center",orderable:!1,searchable:!1},{data:"id",name:"id",visible:!1},{data:"no_so",name:"no_so",className:"text-center"},{data:"tanggal",name:"tanggal"},{data:"customer",name:"customer"},{data:"metode_pembayaran",name:"metode_pembayaran",className:"text-center"},{data:"total_qty",name:"total_qty",className:"text-end",render:$.fn.dataTable.render.number(".",",",0)},{data:"total_diskon",name:"total_diskon",className:"text-end",render:$.fn.dataTable.render.number(".",",",0,"Rp ")},{data:"grand_total",name:"grand_total",className:"text-end fw-bold",render:$.fn.dataTable.render.number(".",",",0,"Rp ")},{data:"approval_level",name:"approval_level"},{data:"status",name:"status"},{data:"keterangan",name:"keterangan"},{data:null,orderable:!1,searchable:!1,className:"text-center no-export",render:function(a,n,t){let e="";return t.can_show&&(e+=`
