...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="auditi" class="form-control" value="{{ old('auditi', $pkpt->auditi ?? '') }}"
            required>
    </div>
...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <select name="irbanwil" class="form-select">
            ...
            @foreach (['IRBAN I', 'IRBAN II', 'IRBAN III'] as $item)
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="number" name="jadwal_rmp_bulan" class="form-control"
            value="{{ old('jadwal_rmp_bulan', $pkpt->jadwal_rmp_bulan ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Rencana Selesai Pemeriksaan (RSP)</label>
        <input type="number" name="jadwal_rsp_bulan" class="form-control"
            value="{{ old('jadwal_rsp_bulan', $pkpt->jadwal_rsp_bulan ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Rencana Penerbitan Laporan (RPL)</label>
        <input type="number" name="jadwal_rpl_bulan" class="form-control"
            value="{{ old('jadwal_rpl_bulan', $pkpt->jadwal_rpl_bulan ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
